...
function Accordion() {
  ...
  return  <>
      <div className="ml-[14px] xl:ml-[105px]   transition-all duration-1000 mt-10">
...
<div>
  <div 
   ...
   className={`w-[90vw] lg:w-[630px] flex items-center justify-between px-6 pt-5 rounded-xl border  cursor-pointer py-6 transition duration-1000 ease-in-out transform ${
...
Is Devsinc a GDPR-Compliant company?
  ...
  <div
    className={`w-[90vw] lg:w-[630px]    text-sm font-poppins transition-max-height duration-300 ease-in-out overflow-hidden ${
      activeSection === "section1"
  ...
  <div 
   ...
   className={`w-[90vw] lg:w-[630px] flex items-center justify-between px-6 pt-5 rounded-xl border  cursor-pointer py-6 transition duration-1000 ease-in-out transform ${
    ...
    <div className="flex items-center gap-4">
      ...
      >
How is Devsincs approach towards tackling challenging projects?              </h1>
    </div>
...
How sooner can we get tech teams assigned to your project normally?
  ...
  Devsinc offers either a team building plan where you can hire customized teams according to your business needs or a fixed bid plan with a particular cost estimation based on your projects requirements.  </div>
</div>
...
What types of plans are available by Devsinc?              </h1>
  ...
  Devsinc offers either a team building plan where you can hire customized teams according to your business needs or a fixed bid plan with a particular cost estimation based on your project requirements.  </div>
</div>
