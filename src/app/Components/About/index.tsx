...
function About() {
  ...
  return (
    <>
      <h1 className="font-poppins  ml-[14px]    transition-all duration-1000 md:ml-[47px] mt-56 text-4xl tracking-tight font-semibold text-[#042638]   lg:text-4xl xl:text-4xl">
      ...
      className={`font-poppins border-2 rounded-md flex w-[90vw] md:w-[350px] p-[21px] font-medium flex-row gap-8 items-center
    ...
    <img className=" w-[90vw] md:w-[360px] object-cover h-[100px] md:h-[360px] rounded-tl-xl   md:rounded-bl-xl rounded-bl-none      rounded-tr-xl md:rounded-tr-none  " src="Education.webp" alt="Error" />  
    <div className="  w-[90vw] md:w-[360px]  h-[270px] md:h-[360px] relative shadow-2xl rounded-2xl  ">
        ...
        <button className="bg-[#0ebab1]  md:rounded-bl-none rounded-bl-xl   rounded-br-xl  w-[90vw] md:w-[360px] absolute top-[207px]  md:top-[296px] py-5 text-white flex justify-center flex-row gap-2 items-center font-poppins">
          ...
          >
            ...
            <g mask="url(#mask0_527_522)">
             ...
             {activeTab === "tab2" &&
       <div className="flex flex-col md:flex-row ">
       <img className="  w-[90vw] md:w-[360px] object-cover h-[100px] md:h-[360px] rounded-tl-xl   md:rounded-bl-xl rounded-bl-none      rounded-tr-xl md:rounded-tr-none  " src="Healthcare.png" alt="Error" />  
       <div className="  w-[90vw] md:w-[360px]  h-[270px] md:h-[360px] relative shadow-2xl rounded-2xl   ">
           ...
           <button className="bg-[#0ebab1]  md:rounded-bl-none rounded-bl-xl   rounded-br-xl  w-[90vw] md:w-[360px] absolute top-[207px]  md:top-[296px] py-5 text-white flex justify-center flex-row gap-2 items-center font-poppins">
             ...
             >
              ...
              {activeTab === "tab3" && 
             <div className="flex flex-col md:flex-row ">
             <img className=" w-[90vw] md:w-[360px] object-cover h-[100px] md:h-[360px] rounded-tl-xl   md:rounded-bl-xl rounded-bl-none     rounded-tr-xl md:rounded-tr-none  " src="FIntech.png" alt="Error" />  
             <div className="  w-[90vw] md:w-[360px]  h-[270px] md:h-[360px] relative shadow-2xl rounded-2xl  ">
             ...
             {activeTab === "tab4" && 
        <div className="flex flex-col md:flex-row ">
        <img className=" w-[90vw] md:w-[360px] object-cover h-[100px] md:h-[360px] rounded-tl-xl    md:rounded-bl-xl rounded-bl-none      rounded-tr-xl md:rounded-tr-none  " src="E-commerce.png" alt="Error" />  
        <div className=" w-[90vw] md:w-[360px]  h-[270px] md:h-[360px] relative shadow-2xl rounded-2xl   ">
...
Change the way you manage business   </a>
              ...
              {activeTab === "tab5" &&
          <div className="flex flex-col md:flex-row ">
          <img className=" w-[90vw] md:w-[360px] object-cover h-[100px] md:h-[360px] rounded-tl-xl    md:rounded-bl-xl rounded-bl-none      rounded-tr-xl md:rounded-tr-none  " src="Automotive.webp" alt="Error" />  
          <div className="   w-[90vw] md:w-[360px]  h-[270px] md:h-[360px] relative shadow-2xl rounded-2xl   ">
