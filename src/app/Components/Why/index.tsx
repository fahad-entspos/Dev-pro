...
<div className='relative w-full top-28 overflow-hidden transition-all duration-1000'>
  <img
    ...
    className='w-full h-[100vh] object-cover transition-all duration-1000 xl:h-[130vh] lg:h-[130vh] md:h-[110vh] sm:h-[110vh]'
    src="mohammad-rahmani-lPKIb8dJ8kw-unsplash.jpg"
    alt="Error "
  />

  <div className="absolute top-4 text-white transition-all duration-1000">
    <h2 className="font-poppins text-[#0ebab1] text-2xl tracking-tight transition-all duration-1000 lg:text-3xl xl:text-4xl font-bold mt-4 md:mt-8 ml-4 md:ml-12">Why Choose Devsinc? </h2>
    <p className="font-poppins text-[#c7c7c7] text-xs sm:text-sm tracking-tight transition-all duration-1000 md:text-base lg:text-lg xl:text-lg mt-4 md:mt-5 ml-4 md:ml-12">While sustaining the vision to embrace the future seamlessly, <br /> we commit to transparency and a proactive approach to <br />address conventional and non-conventional IT solutions. Our <br />tenacity has been the cornerstone in acing new levels of <br />innovation and digital experiences. Our core expertise covers <br />all possible angles of solutions; from custom product <br /> development, Generative AI integrations, data modernizations, <br /> and cloud operations, to business consultancy</p>

    <button className='bg-transparent border-2 transition-all duration-1000 text-white rounded-md ml-4 md:ml-12 mt-5 md:mt-6 px-8 py-2 flex flex-row gap-2 items-center font-poppins'>
      <a href="#">Connect Now</a>
    </button>
  </div>

  <div className="absolute top-[300px] sm:top-[470px] ml-4 md:ml-12  transition-all duration-1000">
    <div className="flex flex-col sm:flex-row items-center justify-center w-full gap-3 lg:gap-14 text-white font-poppins transition-all duration-1000">
